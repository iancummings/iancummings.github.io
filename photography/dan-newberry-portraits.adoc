...
== Settings
Fully manual for consistency
* 1/125, not critical, and in general you can chnage to balance flash light with ambient 
* ISO 100
...
=== Model
 and the tone of the clothing will be of a darker tone. They don’t need to be black strictly speaking.
...
=== Low Key
* for low key/black backgrounds the model needs to be in the order of 3m/10ft away from black background, the light source shoould be slightly behind model with model looking left towards the light.
* or use the Glyn Dewis method, softbox pointing in sideways to model (4ft), 
* The background should be dark, usually dark grey or black.
* the tone of the clothing should be of a darker tone, and the absence of colour in low key images can lend itself to this look.
* As well as choosing dark clothes, avoid ones with patterns, as this will draw attention away from the face.
image:low-key-portrait-examples-02.jpg[]
