...
** link:https://websites.lightrocket.com/familycummings[Family]
** link:https://websites.lightrocket.com/ian_cummings[personal]
...
Framing
* Gregory Crewdson +
plan your images, be intentional
* Annie Leibowitz +
...
* William Klein
* Daido Moriyama
* Robert Frank and his seminal work “The Americans"
* "Shoreditch Wildlife" by Dougie Wallace

== Locations
* link:locations.html[main locations page]
* see also link:brian-lloyd-duckett.html[Brian Lloyd Duckett's suggestions]



== Brian Lloyd Duckett
A link:brian-lloyd-duckett.html[page] of lists of locations and books suggested by his podcasts
...
=== DoStreetPhotography
* link:dostreetphotography.html[DoStreetPhotography]

== Others
* link:street-photography.html[Street Photography]
** link:saul-leiter.html[Saul Leiter]
** link:StreetPhotography101[Street Photography 101 (pdf)]
...
== Flash
* link:canon-80d-flash.html[Flash on Canon 80D]
...
* link:posing-groups.html[Posing Groups]
* link:sunny16.html[Sunny 16]

== Fuji
* link:x100v.html[Fuji X100V]
* link:fujifilm-film-simulations.html[File Simulations/Recipes]
...
* link:lightrocket.html[LightRocket]

=== Rating an Image

==== TPC

5* Great photo, well thought out and executed, stands above the rest

4* Great photo, well thought out and executed

3* Good photo, well photographed, could have been more challenging

2* Nice photo, good focus, well exposed

1* Photo meets the brief and is a good attempt
...
== Talks, Workshops, Camversation etc
...
* link:camversation.html[Camversation]
* link:street-with-matt.html[Street with Matt]


== Places to go

=== London
The link:the-photographers-guide-to-london.pdf[London Photography Guide] by Corey Huges
...
* evening
** Oxford Circus +
stand on central reservation and get busses going past +
illuminated signs in reflection of wet paving slabs +
include people walking in umberellas +
** west end +
standing between georgian pillars looking down road
