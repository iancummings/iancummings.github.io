...
== Strimmer Kawasaki TJ27
spark plug BPMR6A, or NGK 4972 BPMR6A Nickel Spark Plug
...
|===
| red flashing | < 20%
| yellow flashing | 20-69%
| green flashing | 70-99%
| green solid | fully charged
|===

Headphones take half an hour to recharge, the case takes 1:45 +
Earbuds 35mAh each, case 350mAh

Playtime earbuds: 6h +
10min quick charge for 2h playtime.
...
NOTE: I joined gmail 17th September 2004
...
* Uniqlo: medium
* walking shoes laces = 130cm corded
...
=== Horl
==== Specs
horl2 diamond side is 46um about 320 or 420 grit, the ceramic side is 1000 grit
horl3 
...
==== Techniques
Normally 5-10 strokes of sharpening should be ok, if knife is a bit blunt then up to 50.
...
=== Pixel 9a
Screen Protector: Spigen: Glas.tR EZ FIT +
Installation link:https://install.spigen.com/blogs/phone/glas-tr-ez-fit-for-google-pixel[video]

== Travel
=== Car Parks in Brighton
* Regency Mews Secure Car Parking - 4.8
* Churchill Square Red Car Park - 3.7 - Regency Road, Brighton & Hove, BN1 2RU
* Churchill Square Green Car Park - 3.4 - Cannon Place, BN1 2FB
* Trafalgar Street Car Park - 4.1 - Blackman St, Brighton and Hove, Brighton BN1 4DZ
* London Road Car Park - 3.9 - 65 Providence Pl, Brighton and Hove, Brighton BN1 4GE
* Brighton Station - 3.6 - Brighton Multistorey car park,  Stroudley Road, BN1 4LF Brighton

== Desk Chair
https://www.posturite.co.uk/rh-logic-300-400-replacement-parts
Mine is RH 300 I think. Bought spares from link:https://backworld.co.uk/shop/rh-8s-armrest-pad/[here]
